      ...
      <div class="owl-carousel owl-theme heroCarousel">
        <div class="item">
          <div class="hero__slide">
            <img src="<?php echo base_url('assets/img/hero-2.png') ?>" alt="">
        ...
        <div class="item">
          <div class="hero__slide">
            <img src="<?php echo base_url('assets/img/hero-1.png') ?>" alt="">
            <div class="hero__slideContent text-center">
              <h1>Dream Heaven City</h1>
              <p>If you are looking at blank cassettes on the web Lorem ipsum dolor sit amet, consectetur adipisicing  eiusmod tempor incididunt.</p>
							<a class="btn btn--leftBorder btn--rightBorder" href="#/">Details</a>
        ...
        <div class="item">
          <div class="hero__slide">
            <img src="<?php echo base_url('assets/img/hero-3.png') ?>" alt="">
            <div class="hero__slideContent text-center">
              <h1>Dream Heaven City</h1>
              <p>If you are looking at blank cassettes on the web Lorem ipsum dolor sit amet, consectetur adipisicing  eiusmod tempor incididunt.</p>
							<a class="btn btn--leftBorder btn--rightBorder" href="#/">Details</a>							
			...
			<div class="row align-items-center">
				<div class="col-md-5">
					<div class="about__img text-center text-md-left mb-5 mb-md-0">
						<img class="img-fluid" src="<?php echo base_url('assets/img/about.png') ?>" alt="">
		...
		<div class="container">
			...
			<div class="row align-items-end pb-md-5 mb-4">
				<div class="col-md-7 mb-4 mb-md-0">
					<div class="portfolio__img">
						<img class="img-fluid" src="<?php echo base_url('assets/img/portfolio1.png') ?>" alt="">
					</div>
				</div>
			...
			<div class="row align-items-end pb-md-5 mb-4">
				...
				<div class="col-md-7 mb-4 mb-md-0 order-1 order-md-2">
					<div class="portfolio__img">
						<img class="img-fluid" src="<?php echo base_url('assets/img/portfolio2.png') ?>" alt="">
					</div>
				</div>
			</div>
			...
			<div class="row align-items-end pb-md-5 mb-4">
				<div class="col-md-7 mb-4 mb-md-0">
					<div class="portfolio__img">
						<img class="img-fluid" src="<?php echo base_url('assets/img/portfolio3.png') ?>" alt="">
					</div>
				</div>
			...
			<div class="row align-items-end pb-md-5 mb-4">
				...
				<div class="col-md-7 order-1 order-md-2 mb-4 mb-md-0">
					<div class="portfolio__img">
						<img class="img-fluid" src="<?php echo base_url('assets/img/portfolio4.png') ?>" alt="">
					</div>
				</div>
			</div>
			...
			<div class="owl-carousel owl-theme testimonialCarousel">
				<div class="item">
					<div class="media testimonial__slide">
						<img class="img-fluid mr-4" src="<?php echo base_url('assets/img/testimonial.png') ?>" width="120" height="125" alt="">
						<div class="media-body">
							<blockquote>
